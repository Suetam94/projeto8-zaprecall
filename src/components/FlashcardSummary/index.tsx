import {
    FlashcardSummaryContainer, FlashcardSummaryContent,
    FlashcardSummaryHeader, FlashcardSummaryHits, FlashcardSummaryHitsContainer,
    FlashcardSummaryImage, FlashcardSummaryStatus,
